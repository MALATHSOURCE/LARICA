...
send(msg.chat_id_, msg.id_,Text)
return false
endif text == 'م6' and Addictive(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
{
{text = 'آوآمر التسليه', callback_data=data.sender_user_id_.."/help6"},
},
{
{text = 'الاوامر الرئيسيه', callback_data=data.sender_user_id_.."/help"},
},
...
elseif Text and Text:match('(.*)/help6') and Constructor(data) then  
