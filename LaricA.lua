...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' • مـلٱذ ، كࢪاهيةه  ', url="t.me/sSs_sSs"}}, 
} 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '• مـلٱذ ، كࢪاهيةه   ',url="t.me/sSs_sSs"}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sSs_sSs&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
