...
if database:sismember(bot_id.."LaricA:creator:User",result.id_) then
dev = "المالك ،" else dev = "" end
...
keyboard.inline_keyboard = {
{
{text = '𝘿𝒆𝙑𝒆𝙡𝒐𝙋𝒆𝙍',url="https://t.me/LaRiCaTeam"},
},
{
{text = '𝙎𝒐𝙐𝒓𝘾𝒆 𝙇𝒂𝙍𝒊𝘾𝒂',url="https://t.me/BBBBRR"},
},
} 
local msg_id = msg.id_/2097152/0.5
