...
keyboard.inline_keyboard = {
{
{text = '𝙎𝒐𝙐𝒓𝘾𝒆 𝙇𝒂𝙍𝒊𝘾𝒂',url="https://t.me/zzzii"},
},
{
{text = '𝘿𝒆𝙑𝒆𝙡𝒐𝙋𝒆𝙍',url="https://t.me/sSs_sSs"},
},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/zzzii&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
