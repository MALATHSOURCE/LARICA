...
{
{text = 'آوآمر آلمنشئين', callback_data=msg.sender_user_id_.."/help4"},{text = 'العاب التسلية', callback_data=data.sender_user_id_.."/play"},{text = 'آوآمر آلمطورين', callback_data=msg.sender_user_id_.."/help5"},
},
{
...
local Text ="• تم اللغاء منع كل المتحركات"
inline = {
{{text = '• LaricA 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/LaRiCaTeam'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
