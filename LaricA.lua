...
if text == "نسبه التلزيك" or text == "نسبه تلزيك" and msg.reply_to_message_id_ ~= 0 and Addictive(msg) then
if not database:get(bot_id..'Cick:lov'..msg.chat_id_) then
database:set(bot_id..":"..msg.sender_user_id_..":lov_Bots"..msg.chat_id_,"sendlove")
Text = '🔰┇الان ارسل اسمك واسم الشخص الثاني :'
send(msg.chat_id_, msg.id_,Text) 
...
if text and text ~="نسبه التلزيك" and database:get(bot_id..":"..msg.sender_user_id_..":lov_Bots"..msg.chat_id_) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local Text = '📥┇اليك النتائج الخـاصة :\n\n📮┇نسبه التلزيك بيـن : *'..text..'*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• '..sendnum..'%',url="https://t.me/LaRiCaTeam"},
