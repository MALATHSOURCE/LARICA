...
elseif database:sismember(bot_id.."LaricA:Basic:Constructor23"..chat_id, user_id) then
var = "المالك"
elseif database:sismember(bot_id.."LaricA:Basic:Constructor"..chat_id, user_id) then
...
function Function_LaricA(extra, result, success)
database:srem(bot_id.."LaricA:Basic:Constructor23"..msg.chat_id_, result.sender_user_id_)
...
function Function_LaricA(extra, result, success)
if result.id_ then
database:srem(bot_id.."LaricA:Basic:Constructor23"..msg.chat_id_, result.id_)
...
function Function_LaricA(extra, result, success)
database:sadd(bot_id.."LaricA:Basic:Constructor23"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."LaricA:Basic:Constructor23"..msg.chat_id_, result.id_)
