...
if not database:get(bot_id.."y:LaricA:msg:media"..msg.chat_id_) and (msg.content_.text_) or (msg.content_.animation_) or (msg.content_.photo_) or (msg.content_.video_) or (msg.content_.document) or (msg.content_.sticker_) or (msg.content_.voice_) or (msg.content_.audio_) then    
...
send(msg.chat_id_, msg.id_,'✅꒐ تم تفعيل الايدي في المجموعة') 
end
...
send(msg.chat_id_, msg.id_,'❎꒐ تم تعطيل الايدي في المجموعة') 
end
...
send(msg.chat_id_, msg.id_,'✅꒐ تم تفعيل الايدي في المجموعة بالصوره') 
end
...
send(msg.chat_id_, msg.id_,'❎꒐ تم تعطيل الايدي في المجموعة بالصوره') 
end
...
local Texting = {
'منورني ياورده',
"معيدي ولطش برب الصوره ",
"هنا التمبلر ياب",
"من تجيب صورا ع كد فلوسك",
"معيدي ولطش برب الصوره؟ ",
"معندك غير هلصوره تريد ادزلك؟ ",
}
...
send(msg.chat_id_, msg.id_,'⚠️꒐ ليس لديك صوره  \n'..'\n*🏷꒐ ايديك : '..Id..'\n🚹꒐ يوزرك :* ['..UserName_User..']*\n⏏️꒐ موقعك : '..Status_Gps..'\n💭꒐ رسائلك : '..NumMsg..'\n🗯꒐ سحكاتك :'..message_edit..' \n📊꒐ تفاعلك : '..TotalMsg..'\n🚸꒐ الالعاب : '..Num_Games..'*') 
end
else
if get_id then
local get_id = get_id:gsub('#AddMem',Add_Mem) 
...
database:set(bot_id.."y:LaricA:msg:media"..msg.chat_id_,true)
...
database:del(bot_id.."y:LaricA:msg:media"..msg.chat_id_)
...
t = '⏺꒐ اليك الملفات الموجودة في البوت \n  ━═━═━═━\n'
i = 0
for v in io.popen('ls LaricA_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
{
{text = 'آوآمر التعطيل', callback_data=msg.sender_user_id_.."/homeaddwd"},{text = 'آوآمر القفل', callback_data=msg.sender_user_id_.."/homelocks"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '𝙎𝒐𝙐𝒓𝘾𝒆 𝙇𝒂??𝒊𝘾??',url="https://t.me/LaRiCaTeam"},
},
{
{text = '𝘿𝒆𝙑𝒆𝙡𝒐𝙋𝒆𝙍',url="https://t.me/BBBBRR"},
},
...
print("it is Bot")
Namebot = (database:get(bot_id.."LaricA:Name:Bot") or "تشاكي")
local Texti = "↞ أهلـين اسمي "..Namebot.." 🐉\n\n↞ اختصاصي ادارة المجموعات من السبام والخ..\n↞ للتفعيل ارفعني مشرف وارسل تفعيل في المجموعه ."
keyboard = {} 
