...
if text == "المطور" then 
local DevCh1 = DevAbs:get(LaricA.."DevAbs3")
local DevText = DevAbs:get(LaricA.."DevText")
if DevCh1 then DevCh = '\nϮ*Dev Ch* ↬ ['..DevCh1..']' else DevCh = '' end
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp) 
if dp.username_ ~= false then DevUser = '@'..dp.username_ else DevUser = dp.first_name_ end
if DevText then
Text_Dev(msg.chat_id_, msg.id_, 1, DevText, 1, "md")
else
Text_Dev(msg.chat_id_, msg.id_, 1, 'Ϯ*Dev User* ↬ ['..DevUser..']\nϮ*Dev Id* ↬ '..DevId..''..DevCh, 1, "md")
end
end,nil)
end 
