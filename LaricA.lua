...
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."LaricA:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:set(bot_id.."LaricA:Private:Group:Link"..msg.chat_id_,Link)
...
database:setex(bot_id.."LaricA:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
...
database:set(bot_id.."LaricA:Link_Group"..msg.chat_id_,true) 
...
if Addictive(msg) then  
database:del(bot_id.."LaricA:Link_Group"..msg.chat_id_) 
...
database:del(bot_id.."LaricA:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
Text = [[
*𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚* [𝙡𝙖𝙧𝙞𝙘𝙖 𝙩𝙚𝙖𝙢 †](t.me/MALATHSOURCE)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝙨𝙤𝙪𝙧𝙘𝙚 𝙘𝙝𝙖𝙣𝙣𝙚𝙡',url="https://t.me/MALATHSOURCE"},
},
{
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MALATHSOURCE&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
