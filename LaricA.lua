...
{
{text = 'آوآمر آلمنشئين', callback_data=data.sender_user_id_.."/help4"},{text = 'المطيزه', callback_data=data.sender_user_id_.."/help6"},{text = 'آوآمر آلمطورين', callback_data=data.sender_user_id_.."/help5"},
},
{
{text = 'الاوامر الرئيسيه', callback_data=data.sender_user_id_.."/help"},
},
