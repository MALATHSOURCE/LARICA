...
{
{text = ' 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚅𝙸𝚁𝙰', url="t.me/LaRiCaTeam"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
Text = [[
• اوامر البوت نللمنظفين 
━═━═━═━═━═━═━═━
• الميديا - لعرضت عدد الميديا المرسله
• امسح - لمسح الميديا المرسله
━═━═━═━═━═━═━═━
• اوامر البوت للمالكن ،
• رفع منظف - تنزيل منظف
• المنظفين - مسح النمنظفين
━═━═━═━═━═━═━═━
• تفعيل تنظيف الوسائط
• تعطيل تنظيف تالوسائط
• ضع وقت التنظيفت + الوقت 
• مسح الوسائتط
• تفعيل المسح التلقائي
• وضع وقت المسحن + الوقت
• تعطيل المسح التلقائي
[LaRiCaTeam](t.me/LaRiCaTeam)
]]
send(msg.chat_id_, msg.id_,Text)
