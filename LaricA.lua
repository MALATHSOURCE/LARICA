...
local Text =[[
𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚 [𝙨𝙤𝙪𝙧𝙘𝙚 𝙡𝙖𝙧𝙞??𝙖 🦇](t.me/LaRiCaTeam)
...
{
{text = 'آوآمر آلمنشئين', callback_data=msg.sender_user_id_.."/help4"},{text = 'العاب التسلية', callback_data=data.sender_user_id_.."/help6"},
},
{
{text = 'آوآمر آلمطورين', callback_data=msg.sender_user_id_.."/help5"},
},
{
...
{
{text = 'العاب التسلية', callback_data=data.sender_user_id_.."/help6"},
},
{
{text = 'الاوامر الرئيسيه', callback_data=data.sender_user_id_.."/help"},
},
